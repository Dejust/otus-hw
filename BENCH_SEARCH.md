...
Индексу по last_name может быть отдано предпочтение, если потребуется выгружать большей данных. С одной стороны, по эффективности, он сравним с композитным индексом, при этом издержки на его поддержку - меньше.
