...
Обычный индекс по last_name выгоднее в том плане, что снижает издержки при обновлении таблицы. По результатам тестов сравним с композитным. 

Композитный следует применить, если пользователей с одинаковыми фамилиями станет слишком много (1kk?).
